...
const HallPage = async() => {
    ...
    return (
     <>
{/* 
        <div className="text-justify px-10 pt-20">
        laborum voluptatem quibusdam voluptate. Doloremque, eligendi distinctio?
        { 
            data.map((hall) => (
                <div key={hall._id}>
                    <h1>{hall.hallName}</h1>
   ...
   <div class="container m-auto px-6 text-gray-600 md:px-12 xl:px-6">
    ...
    <div class="lg:w-3/4 xl:w-3/4 lg:mx-auto">
        ...
        <div class="mb-5 group relative -mx-4 sm:-mx-8 p-6 sm:p-8 rounded-3xl bg-white  border border-transparent hover:border-gray-100  shadow-2xl shadow-transparent hover:shadow-gray-600/10 sm:gap-8 sm:flex transition duration-300 hover:z-10">
          ...
          <div class="sm:p-2 sm:pl-0 sm:w-4/6">
            <span class="mt-4 mb-2 inline-block font-medium text-gray-400  sm:mt-0">Jul 27 2022</span>
            ...
            <div class="flex gap-4">
              <a href="#" class="px-3 py-1 rounded-full border border-gray-100 text-sm font-medium text-primary transition duration-300 hover:border-transparent hover:bg-primary hover:text-white  ">
                Tailwindcss
              </a>
              <a href="#" class="px-3 py-1 rounded-full border border-gray-100 text-sm font-medium text-primary transition duration-300 hover:border-transparent hover:bg-primary hover:text-white  ">
                VueJS
        ...
        <div class="mb-5 group relative hover:z-10 -mx-4 sm:-mx-8 p-6 sm:p-8 rounded-3xl bg-white  border border-transparent hover:border-gray-100  shadow-2xl shadow-transparent hover:shadow-gray-600/10 sm:gap-8 sm:flex transition duration-300">
          <div class="sm:w-2/6 rounded-3xl overflow-hidden transition-all duration-500 group-hover:rounded-xl">
            <Image
